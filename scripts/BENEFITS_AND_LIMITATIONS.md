...
```bash
python quick_start.py --mb-url http://192.168.2.13:5001/ --profile high_quality <!-- TODO(docval): --profile option declared but not implemented in code as of 2026-05-31 -->
```
