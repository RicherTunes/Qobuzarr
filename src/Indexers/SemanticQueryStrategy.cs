...
namespace Lidarr.Plugin.Qobuzarr.Indexers
{
    ...
    public class SemanticQueryStrategy
    {
        ...
        public List<string> BuildQueriesForBugCase(string artist, string album)
        {
            ...
            var sanitizedArtist = SanitizeInput(artist);
            var sanitizedAlbum = SanitizeInput(album);
            
            var strategy = DetermineStrategy(sanitizedArtist, sanitizedAlbum);
            var queries = BuildQueriesForStrategy(sanitizedArtist, sanitizedAlbum, strategy);
